...
export = {
  ...
  getDiscordId(input: any, options: any, callback: Function) { //TODO: replace with promise based functions
  ...
  getAccessLevel(input: any, options: any, callback?: Function) { //TODO: replace with promise based functions
